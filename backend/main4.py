...
import io
from model4 import PartCounter  # ← Matches your filename

# ======================
# CONFIG
# ======================
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
MODEL_PATH = "finetunemodel_classify.pth"  # Your model file
...
# Use strict=False to ignore any mismatched keys (e.g. old classifier)
...
async def predict(file: UploadFile = File(...)):
    ...
    with torch.no_grad():
        ...
        # Reshape and get predicted count (0–4) for each part
        logits_reshaped = logits.view(4, 5)
        predicted_classes = torch.argmax(logits_reshaped, dim=1)
